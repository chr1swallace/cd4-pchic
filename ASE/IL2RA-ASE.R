...
x <- read.table("additional-file-15-tableS10-IL2RA-ASE.csv.gz") %>% as.data.table()
...
w <- 10
x[,stim:=factor(stim,levels=c("genomic","time0","non-activated","activated"))]
x[,snp:=factor(snp,levels=c("rs61839660 (intron 1)","rs12722495 (intron 1)","rs12244380 (3' UTR)"))]
